...
from verl.utils.dataset.jigsaw_utils import slice_image, process_video_jigsaw, center_crop,draw_numbered_markers
    ...
    def __getitem__(self, item):
        ...
        if self.image_key in row_dict:
            ...
            if 'data_source' in row_dict and 'jigsaw' in row_dict['data_source']:
                ...
                if 'depth_jigsaw' in row_dict['data_source']:
