...
if __name__ == "__main__":
    ...
    DATA_PATH = os.path.join(args.data_path, 'AoTBench/valid_data.json')
    VIDEO_ROOT = os.path.join(args.data_path, 'AoTBench')
    MODEL_PATH = args.model_path
    OUTPUT_PATH = os.path.join('./logs/aotbench/', f"frame{max_frames}_pixel{pix}_"+args.save_name)
