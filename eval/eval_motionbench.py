...
if __name__ == "__main__":
    ...
    DATA_PATH = os.path.join(args.data_path, 'MotionBench/motionbench_val.json')
    VIDEO_ROOT = os.path.join(args.data_path, 'MotionBench')
    MODEL_PATH = args.model_path
    OUTPUT_PATH = os.path.join('./logs/motionbench/', f"frame{max_frames}_pixel{pix}_"+args.save_name)
    ...
    data = [sample for sample in data if sample['video'] not in ['MotionBench/self-collected/CWBOtkJ7M6uDG75t.mp4', 'MotionBench/self-collected/wzOKuIKLubEaqmxy.mp4', 'MotionBench/self-collected/D1ZhP7icVsaR4dY3.mp4', 'MotionBench/self-collected/YV3ezdj2HwiA2Zwb.mp4']]
    ...
    if rank == 0:
        ...
        for input_example, model_output in zip(data, all_outputs):
            ...
            task_type = input_example['question_type']
