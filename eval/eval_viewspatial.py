...
if __name__ == "__main__":
    ...
    DATA_PATH = os.path.join(args.data_path, 'ViewSpatial-Bench/ViewSpatial-Bench.json')
    IMAGE_ROOT = args.data_path
    MODEL_PATH = args.model_path
    OUTPUT_PATH = os.path.join('./logs/viewspatial/', args.save_name)
